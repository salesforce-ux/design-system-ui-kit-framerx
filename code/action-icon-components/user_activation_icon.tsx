...
export function user_activation_icon(props) {
  return (
	...
	<path d="m16 46h-2c-1.1 0-2-0.9-2-2v-2c0-1.1 0.9-2 2-2h2c1.1 0 2 0.9 2 2v2c0 1.1-0.9 2-2 2z m22-34h-2c-1.1 0-2-0.9-2-2v-2c0-1.1 0.9-2 2-2h2c1.1 0 2 0.9 2 2v2c0 1.1-0.9 2-2 2z" fill={props.fill}/>
</svg>
  );
};

addPropertyControls(user_activation_icon, {
  fill: {
